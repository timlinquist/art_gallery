$(document).ready(function() {
  ...
  var ajaxsubmit_options = {
    ...
    success: function(){
    	enable_form("form");
			flash_notice_message("Category successfully updated.");
		},
		error: function(){
			enable_form();
			flash_error_message("Unable to update category. Please correct any errors and attempt to update the category again.");
		}
  }
